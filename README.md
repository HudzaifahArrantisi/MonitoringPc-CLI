...
```
┌─────────────────────────────────────────────────────────────────────┐
│  MONITOR-PC  │  Realtime Performance Dashboard  │  2026-05-29      │
├────────────────────────────────┬────────────────────────────────────┤
│ ⬢ CPU Usage                   │ ⬡ RAM Usage                       │
│  Total  ████████░░░░  35.2%   │  Usage  ██████████░░  66.4%       │
│  C0: 42% C1: 28% C2: 55%     │  Used   10.6 GB / 16.0 GB        │
│  History ▁▂▃▅▆▇█▇▅▃▂▁▃▅▇▆▅▃  │  History ▃▄▅▅▆▆▅▅▄▄▃▃▄▅▆▅▅▄▃▃  │
├────────────────────────────────┼────────────────────────────────────┤
│ ◆ Disk                        │ ⇅ Network                         │
│  C:\  ██████████░░░░  48.2%   │  ↑ Upload    120.5 KB/s           │
│  Used  240.5 GB / 500.0 GB    │  ↓ Download  850.3 KB/s           │
├────────────────────────────────┴────────────────────────────────────┤
│ ⊞ System Info                                                      │
│  Hostname  DESKTOP-ABC  │  OS  Windows 10  │  Uptime  2d 05h 32m  │
│  Processes  248          │  Battery  87%  ⚡ Plugged In             │
└─────────────────────────────────────────────────────────────────────┘
```
